...
generic Linux joystick to ROS2. This node publishes a "Joy" message, which
contains the current state of each one of the joystick's buttons and axes.
...
%changelog
* Thu Apr 30 2026 Chris Lalancette <clalancette@openrobotics.org> - 3.3.0-4
- Autogenerated by Bloom

* Tue Apr 21 2026 Chris Lalancette <clalancette@openrobotics.org> - 3.3.0-2
- Autogenerated by Bloom
